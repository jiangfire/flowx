...
func (r *mockApprovalRepository) GetWorkflowByID(ctx context.Context, tenantID, id string) (*approval.Workflow, error) {
...
func (r *mockApprovalRepository) UpdateWorkflowStatus(ctx context.Context, tenantID, id string, status string) error {
...
func (r *mockApprovalRepository) GetInstanceByID(ctx context.Context, tenantID, id string) (*approval.WorkflowInstance, error) {
...
func (r *mockApprovalRepository) ListApprovalsByInstance(ctx context.Context, tenantID, instanceID string) ([]approval.Approval, error) {
