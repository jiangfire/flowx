...
type DataPolicyRepository interface {
	...
	GetByID(ctx context.Context, tenantID, id string) (*domaintool.DataPolicy, error)
...
type DataAssetRepository interface {
	...
	GetByID(ctx context.Context, tenantID, id string) (*domaintool.DataAsset, error)
...
type DataQualityRuleRepository interface {
	...
	GetByID(ctx context.Context, tenantID, id string) (*domaintool.DataQualityRule, error)
...
type DataQualityCheckRepository interface {
	...
	GetByID(ctx context.Context, tenantID, id string) (*domaintool.DataQualityCheck, error)
	...
	Delete(ctx context.Context, tenantID, id string) error
	GetByRuleAndAsset(ctx context.Context, tenantID, ruleID, assetID string) (*domaintool.DataQualityCheck, error)
}
